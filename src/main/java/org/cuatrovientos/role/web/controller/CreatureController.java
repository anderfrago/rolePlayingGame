...
public class CreatureController {
    ...
    public Creature deleteCreature(@RequestBody CreatureDto creature, BindingResult bindingResult) {
    ...
    @PostMapping("/edit/{id}")
    public Creature modifyCreature(@RequestBody CreatureDto creature, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return new Creature();
        }
    ...
    @PostMapping
    public Creature addCreature(@RequestBody CreatureDto creature, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return new Creature();
        }
